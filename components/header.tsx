  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between w-full h-16 px-4 shrink-0 bg-gradient-to-b from-background/10 via-background/50 to-background/80 backdrop-blur-xl">
      ...
      <div className="flex items-center justify-end gap-2">
        <div className="hidden sm:flex items-center gap-1 text-sm font-medium text-blue-600">
          <span>💧</span>
          <span>ION Water Support Assistant</span>
        </div>
        <div className="sm:hidden flex items-center gap-1 text-sm font-medium text-blue-600">
          <span>💧</span>
          <span>ION Support</span>
        </div>
      </div>
    </header>
  )
